                ...
                <div className="grid">
                    <div className="grid-box">
                       <div className="grid-icons" ><img className="" src="./shopping-bag.svg" alt="shopping-bag" /></div> 
                        ...
                        <p>CampusDash is your one-stop shop for all things campus. Whether you need textbooks, snacks, tech gadgets, or dorm supplies, we've got it all.</p>
                    ...
                    <div className="grid-box">
                        ...
                        <p>We partner exclusively with local vendors who understand the unique needs of students. From the campus bookstore to the tech shop, each vendor is carefully vetted to ensure quality, reliability, and fair pricing.</p>
                    ...
                    <div className="grid-icons"><img src="./wallet-money.svg" alt="wallet" /></div>
                        <h5>Easy Payments</h5>
                        <p>Our payment gateway is encrypted and secure, ensuring that your transactions are safe. Plus, with our simple checkout process, you can complete your purchase in just a few taps.</p>
                        <div>
